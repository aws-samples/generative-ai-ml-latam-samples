...
|[Amazon Rekognition logo video analyzer](./samples/video-logo-analyzer/README.md)| Media & Entertainment | This project presents an innovative solution that uses primarily Amazon Rekognition, to automate the detection of specific logos in videos, significantly transforming the operational efficiency of this process. | Python| Spanish |
